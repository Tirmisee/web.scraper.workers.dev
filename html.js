...
<html lang="en" with-selection-styled>
  <head>
    ...
    <meta property="og:url" content="https://webscraper.dimdata.com">
    ...
    <meta name="twitter:url" content="https://webscraper.dimdata.com">
  ...
  <body>
    <div class="Surface">
      <div class="Panel">
        <div class="Panel--top">
          <h1><a href="https://webscraper.dimdata.com" class="Link Link-without-underline"><span class="WebScraperLogo"><span>webscraper</span><span class="WebScraperLogo--muted">.dimdata.com</span></span></a></h1>
        ...
        <main class="Panel--main" is-smooth-scrolling>
          <form id="form" class="Stack" method="GET" action="https://webscraper.dimdata.com">
            <div class="FormField">
        ...
        <div class="Panel--bottom">
          <div class="Row">
            ...
            <a data-js-permalink href="https://webscraper.dimdata.com" class="Button Button-is-bordered" type="button">Permalink</a>
          </div>
        </div>
      </div>
